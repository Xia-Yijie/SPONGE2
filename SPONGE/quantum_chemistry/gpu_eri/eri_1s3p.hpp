    ...
    int shell_buf_size, float prim_screen_tol)
{
    ...
    const int l[4] = {_1S3P_IS_P(0), _1S3P_IS_P(1), _1S3P_IS_P(2), _1S3P_IS_P(3)};
    const int dim_c[4] = {_1S3P_IS_P(0)?3:1, _1S3P_IS_P(1)?3:1, _1S3P_IS_P(2)?3:1, _1S3P_IS_P(3)?3:1};
